...
# Note for migration to new build systems, if this doesn't work with 64 compilers,
# try adding -m32, --32 and -m elf_i386  to CC, AS and LD flags,
# and make sure to  install gcc 32 bit libraries "gcc-multilib for Ubuntu" 
...
CFLAGS	:= $(CFLAGS) $(DEFS) $(LABDEFS) -O0 -fno-builtin -I$(TOP) -MD -Wall -Wno-format -Wno-unused -Werror -ggdb -fno-stack-protector -g3
